...
const AADHAAR_UPDATE_FIELDS: ServiceField[] = [
  ...
  },
  {
    ...
    requiresFile: true,
    voiceLabel: { en: 'Please describe the document you are uploading', hi: 'कृपया अपने दस्तावेज़ का विवरण दें', te: 'దయచేసి మీ డాక్యుమెంట్ వివరణ ఇవ్వండి' }
  },
  {
...
const PAN_CARD_FIELDS: ServiceField[] = [
...

  {
    ...
    requiresFile: true,
    voiceLabel: { en: 'Please upload your identity proof document like Aadhaar, Voter ID, or Passport', hi: 'कृपया अपने पहचान के प्रमाण दस्तावेज़ जैसे आधार, वोटर आईडी, या पासपोर्ट अपलोड करें', te: 'దయచేసి ఆధార్, ఓటర్ ఐడి లేదా పాస్‌పోర్ట్ వంటి మీ గుర్తింపు ధృవీకరణ పత్రాన్ని అప్‌లోడ్ చేయండి' }
  },

  {
    id: 'poa_file', label: 'Upload Proof of Address', type: 'file',
    requiresFile: true,
    voiceLabel: { en: 'Please upload your address proof like electricity bill, bank passbook, or Aadhaar', hi: 'कृपया अपने पते का प्रमाण जैसे बिजली बिल, बैंक पासबुक, या आधार अपलोड करें', te: 'దయచేసి విద్యుత్ బిల్లు, బ్యాంక్ పాస్‌బుక్ లేదా ఆధార్ వంటి మీ చిరునామా ధృవీకరణ పత్రాన్ని అప్‌లోడ్ చేయండి' }
  },

  {
    id: 'dob_file', label: 'Upload Proof of Date of Birth', type: 'file',
    requiresFile: true,
    voiceLabel: { en: 'Please upload your date of birth proof like birth certificate, Aadhaar, or passport', hi: 'कृपया अपने जन्म तिथि का प्रमाण जैसे जन्म प्रमाण पत्र, आधार, या पासपोर्ट अपलोड करें', te: 'దయచేసి జన్మ ధృవీకరణ పత్రం, ఆధార్ లేదా పాస్‌పోర్ట్ వంటి మీ జన్మ తేదీ ధృవీకరణ పత్రాన్ని అప్‌లోడ్ చేయండి' }
  },
  {
...
const VOTER_ID_FIELDS: ServiceField[] = [
  ...
  },
  {
    ...
    requiresFile: true,
    voiceLabel: { en: 'Please upload any government-issued ID proof like Aadhaar, Birth Certificate, or Passport', hi: 'कृपया सरकार द्वारा जारी किया गया कोई आईडी प्रमाण जैसे आधार, जन्म प्रमाण पत्र, या पासपोर्ट अपलोड करें', te: 'దయచేసి ఆధార్, జన్మ సర్టిఫికేట్ లేదా పాస్‌పోర్ట్ వంటి ప్రభుత్వ-జారీ ఐడి ధృవీకరణ అప్‌లోడ్ చేయండి' }
  },
  {
    id: 'address_proof', label: 'Upload Address Proof', type: 'file',
    requiresFile: true,
    voiceLabel: { en: 'Please upload your address proof like electricity bill, water bill, or rent agreement', hi: 'कृपया अपने पते का प्रमाण जैसे बिजली बिल, पानी बिल, या किराया समझौता अपलोड करें', te: 'దయచేసి విద్యుత్ బిల్లు, నీటి బిల్లు లేదా అద్దెపై ఒప్పంద ვროგ చిరునామా ధృవీకరణ అప్‌లోడ్ చేయండి' }
  },
  {
...
const BIRTH_CERTIFICATE_FIELDS: ServiceField[] = [
  ...
  },
  {
    ...
    requiresFile: true,
    voiceLabel: { en: 'Please upload your hospital birth slip or discharge summary', hi: 'कृपया अपनी अस्पताल की जन्म पर्ची या डिस्चार्ज समरी अपलोड करें', te: 'దయచేసి మీ ఆసుపత్రి بर్త్ స్లిప్ లేదా డిశ్చార్జ్ సమరీ అప్‌లోడ్ చేయండి' }
  },
  {
    id: 'parent_doc', label: 'Upload Parent ID/Aadhaar', type: 'file',
    requiresFile: true,
    voiceLabel: { en: 'Please upload parent Aadhaar card or any government ID', hi: 'कृपया माता-पिता का आधार कार्ड या कोई सरकारी आईडी अपलोड करें', te: 'దయచేసి తల్లిదండ్రుల ఆధార్ కార్డ్ లేదా ఏదైనా ప్రభుత్వ ఐడి అప్‌లోడ్ చేయండి' }
  },
  {
...
const CASTE_CERTIFICATE_FIELDS: ServiceField[] = [
  ...
  },
  {
    ...
    requiresFile: true,
    voiceLabel: { en: 'Please upload your caste certificate or your father caste certificate', hi: 'कृपया अपना जाति प्रमाण पत्र या अपने पिता का जाति प्रमाण पत्र अपलोड करें', te: 'దయచేసి మీ కుల సర్టిఫికేట్ లేదా మీ తండ్రి కుల సర్టిఫికేట్ అప్‌లోడ్ చేయండి' }
  },
  {
    id: 'income_proof_file', label: 'Upload Income Proof', type: 'file',
    requiresFile: true,
    voiceLabel: { en: 'Please upload your income certificate or income proof document', hi: 'कृपया अपना आय प्रमाण पत्र या आय प्रमाण दस्तावेज़ अपलोड करें', te: 'దయచేసి మీ ఆదాయ ధృవీకరణ పత్రం లేదా ఆదాయ ధృవీకరణ దస్తావేజ్ అప్‌లోడ్ చేయండి' }
  },
  {
...
const INCOME_CERTIFICATE_FIELDS: ServiceField[] = [
  ...
  },
  {
    ...
    requiresFile: true,
    voiceLabel: { en: 'Please upload your income proof like salary slip, bank statement, or IT return', hi: 'कृपया अपने आय का प्रमाण जैसे वेतन पर्ची, बैंक स्टेटमेंट, या आईटी रिटर्न अपलोड करें', te: 'దయచేసి జీతం స్లిప్, బ్యాంక్ స్టేట్‌మెంట్ లేదా ఐటీ రిటర్న్ వంటి మీ ఆదాయ ధృవీకరణ అప్‌లోడ్ చేయండి' }
  },
  {
    id: 'family_id_doc', label: 'Upload Family ID/Aadhaar', type: 'file',
    requiresFile: true,
    voiceLabel: { en: 'Please upload family head ID or Aadhaar card', hi: 'कृपया परिवार के मुखिया का आईडी या आधार कार्ड अपलोड करें', te: 'దయచేసి కుటుంబ యజమాని ఐడి లేదా ఆధార్ కార్డ్ అప్‌లోడ్ చేయండి' }
  },
  {
...
const TRANSGENDER_ID_CARD_FIELDS: ServiceField[] = [
  ...
  },
  {
    ...
    voiceLabel: { en: 'Please provide your medical history', hi: 'कृपया अपनी चिकित्सा इतिहास दें', te: 'దయచేసి మీ వైద్య చరిత్రను అందించండి' }
  },
  {
    id: 'hormone_therapy', label: 'Hormone Therapy Details', type: 'textarea',
    voiceLabel: { en: 'Please provide hormone therapy details if any', hi: 'यदि कोई हो तो हार्मोन थेरेपी का विवरण दें', te: 'ఉంటే హార్మోన్ థెరపీ వివరాలను అందించండి' }
  },
  {
    id: 'surgery_details', label: 'Gender Affirmation Surgery Details', type: 'textarea',
    voiceLabel: { en: 'Please provide gender affirmation surgery details if any', hi: 'यदि कोई हो तो लिंग पुष्टि सर्जरी का विवरण दें', te: 'ఉంటే లింగ నిర్ధారణ శస్త్రచికిత్స వివరాలను అందించండి' }
  },
  {
    id: 'psychological_evaluation', label: 'Psychological Evaluation Report', type: 'text',
    voiceLabel: { en: 'Do you have a psychological evaluation report?', hi: 'क्या आपके पास मनोवैज्ञानिक मूल्यांकन रिपोर्ट है?', te: 'మీకు మానసిక మూల్యాంకన నివేదిక ఉందా?' }
  },
  {
    id: 'supporting_documents', label: 'Supporting Documents', type: 'textarea',
...
export const GOVERNMENT_SERVICES: GovernmentService[] = SERVICE_DEFINITIONS;
